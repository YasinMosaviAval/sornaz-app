        ...
        child: Column(
          ...
          children: [
            for (final f in [
              ...
              ListTile(
                title: Text(socialText(c, f.$2, f.$3)),
            ...
            child: ListView(
              ...
              children: [
                ...
                LearningHeading(
                  ...
                  onMore: () => socialPush(context, const ArticlesPage()),
                ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${(filtered.first['author'] as Map?)?['name'] ?? ''}',
                          style: TextStyle(
                            color: dark ? Colors.black : Colors.white,
                          ),
                        ),
                        ...
                        FilledButton(
                          ...
                          onPressed: () => openCourse(filtered.first),
                          child: Text(
                            socialText(context, 'بیشتر بدانید', 'Learn more'),
                          ),
                        ),
                      ],
                    ),
                ...
                LearningHeading(
                  socialText(context, 'دوره‌های به‌روزشده', 'Updated courses'),
                  onMore: () => socialPush(context, CoursesPage(api: api)),
                ),
                ...
                LearningHeading(
                  socialText(context, 'برای شروع یادگیری', 'Start learning'),
                ),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return InkWell(
                        onTap: () => socialPush(
                          context,
                          ProfilePage(api: api, userId: number(a['id'])),
                        ),
                        child: SizedBox(
                          width: 62,
                          child: Column(
